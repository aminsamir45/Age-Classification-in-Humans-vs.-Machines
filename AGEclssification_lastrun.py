...
expName = 'AGEclssification'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sopsahl/Desktop/9-60-Project/AGEclssification_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    InstructionsComponents = [text, Continue]
    ...
    while continueRoutine:
        ...
        if Continue.status == STARTED and not waitOnFlip:
            theseKeys = Continue.getKeys(keyList=['y','n','left','right','space'], ignoreKeys=["escape"], waitRelease=False)
